...
function Contact() {
  ...
  // state use for show or hide alert banners
  ...
  // ref use for foucs on textfeilds
  const firstNameRef = useRef(null);
  const lastNameRef = useRef(null);
  // state use for holds user information
  ...
  /**
   * this method will open form also re initialized state
   */
  ...
  /**
   * this method firstly check some basic validation
   * after that dispatch action
   */
  const saveContactHandler = () => {
    if (firstNameRef.current.value === "") {
      ...
      setSeenForm(false);
      // if user click edit button then we will have id so we can update his contact information
      if (editContactId) {
        let updatedContact = {
          id: editContactId,
  ...
  /**
   * this method run when user press edit button
   * store all information so we can use for update contacts
   * @param {*click contact id} contactId
   * @param {*click contact Fname} contactFname
   * @param {*click contact Lname} contactLname
   * @param {*click contact Status} contactStatus
   */
